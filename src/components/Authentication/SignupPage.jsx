  ...
  const onSubmit = async (formData) => {
    try {
      ...
      if (response.data.token) {
        const jwtUser = jwtDecode(response.data.token);
        setUser(jwtUser); 
        navigate("/"); 
      }
    } catch (error) {
      ...
      <form className="authentication_form signup_form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form_input signup_form_input">
          ...
          <div>
            ...
            <input id="name" className="form_text_input" {...register("name")} />
          ...
          <div>
            ...
            <input id="email" className="form_text_input" {...register("email")} />
          ...
          <div>
            ...
            <input id="cpassword" type="password" className="form_text_input" {...register("confirmpassword")} />
          ...
          <div>
            ...
            <input id="address" className="input_textarea" {...register("deliveryAddress")} />
